...
for /f "tokens=2* delims==" %%J in ('find "vboxAppDirWin=" ^<%config% ') do (set VMApp=%%J)
...
:: Relace first this
%FART% -r -- *.vbox "/Volumes/Untitled/Emulators" "P:\\"

:: then this
%FART% -r -- *.vbox "/Volumes/Untitled/Games" "F:\\"
...
%FART% -r -- *.vbox "/Volumes/Untitled/Program Files/Oracle/VirtualBox/" "C:\Program Files\Oracle\VirtualBox\\"
